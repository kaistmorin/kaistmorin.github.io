---
layout: default
title: "Jonghwi Kim — Outstanding Student Paper Presentation Award"
permalink: /media/events/2022-01-18-jonghwi-kim-outstanding-student-paper-presentation-award/
nav: false
---
...
<div class="media-detail">
  ...
  <h1>Jonghwi Kim — Outstanding Student Paper Presentation Award</h1>
  <p class="detail-date">2022-01-18</p>
  <div class="detail-hero"><img src="{{ '/assets/img/media/events/event-13.jpg' | relative_url }}" alt="Jonghwi Kim — Outstanding Student Paper Presentation Award"></div>
  <div class="detail-body"><p>The paper "Multi-sensor fusion for Autonomous Navigation Experiment in Pohang Canal" received an Outstanding Student Paper Presentation Award from KSOE 2021.</p></div>
</div>

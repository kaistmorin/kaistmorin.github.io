---
layout: default
title: "Dongha Chung — Outstanding Student Paper Presentation"
permalink: /media/events/2016-11-17-dongha-chung-outstanding-student-paper-presentation/
nav: false
---
...
<div class="media-detail">
  ...
  <h1>Dongha Chung — Outstanding Student Paper Presentation</h1>
  <p class="detail-date">2016-11-17</p>
  <div class="detail-hero"><img src="{{ '/assets/img/media/events/event-32.jpg' | relative_url }}" alt="Dongha Chung — Outstanding Student Paper Presentation"></div>
  <div class="detail-body"><p>Dongha Chung received an outstanding student paper presentation award from KSOE 2016 for work on quaternion-feedback attitude control of an underwater vehicle.</p></div>
</div>

---
layout: default
title: "Changyu Lee — Outstanding Student Paper Presentation Award"
permalink: /media/events/2020-12-03-changyu-lee-outstanding-student-paper-presentation-award/
nav: false
---
...
<div class="media-detail">
  ...
  <h1>Changyu Lee — Outstanding Student Paper Presentation Award</h1>
  <p class="detail-date">2020-12-03</p>
  <div class="detail-hero"><img src="{{ '/assets/img/media/events/event-15.jpg' | relative_url }}" alt="Changyu Lee — Outstanding Student Paper Presentation Award"></div>
  <div class="detail-body"><p>The paper "Model Predictive Control for Automatic Berthing of a Twin-Propeller Twin-Rudder Ship" received an Outstanding Student Paper Presentation Award from KSOE 2020.</p></div>
</div>

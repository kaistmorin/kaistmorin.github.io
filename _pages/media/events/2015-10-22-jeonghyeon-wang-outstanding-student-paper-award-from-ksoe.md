---
layout: default
title: "Jeonghyeon Wang — Outstanding Student Paper Award from KSOE"
permalink: /media/events/2015-10-22-jeonghyeon-wang-outstanding-student-paper-award-from-ksoe/
nav: false
---
...
<div class="media-detail">
  ...
  <h1>Jeonghyeon Wang — Outstanding Student Paper Award from KSOE</h1>
  <p class="detail-date">2015-10-22</p>
  <div class="detail-hero"><img src="{{ '/assets/img/media/events/event-37.jpg' | relative_url }}" alt="Jeonghyeon Wang — Outstanding Student Paper Award from KSOE"></div>
  <div class="detail-body"><p>The paper "Optimization of Fish-Like Locomotion using Reinforcement Learning" received an Outstanding Student Paper Award.</p></div>
</div>

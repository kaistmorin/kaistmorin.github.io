---
layout: default
title: "Seonghun Hong — Outstanding Student Paper Award from KSOE 2016"
permalink: /media/events/2017-02-03-seonghun-hong-outstanding-student-paper-award-from-ksoe-2016/
nav: false
---
...
<div class="media-detail">
  ...
  <h1>Seonghun Hong — Outstanding Student Paper Award from KSOE 2016</h1>
  <p class="detail-date">2017-02-03</p>
  <div class="detail-hero"><img src="{{ '/assets/img/media/events/event-31.jpg' | relative_url }}" alt="Seonghun Hong — Outstanding Student Paper Award from KSOE 2016"></div>
  <div class="detail-body"><p>The paper "Image mosaicking using pose-assisted registration for visual inspection of underwater structures" received an Outstanding Student Paper Award.</p></div>
</div>

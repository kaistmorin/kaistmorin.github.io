---
layout: default
title: "Jisung Park — AFCV Best Robot Vision Paper Award"
permalink: /media/events/2016-01-27-jisung-park-afcv-best-robot-vision-paper-award/
nav: false
---
...
<div class="media-detail">
  ...
  <h1>Jisung Park — AFCV Best Robot Vision Paper Award</h1>
  <p class="detail-date">2016-01-27</p>
  <div class="detail-hero"><img src="{{ '/assets/img/media/events/event-34.jpg' | relative_url }}" alt="Jisung Park — AFCV Best Robot Vision Paper Award"></div>
  <div class="detail-body"><p>The work "Model-based pose estimation for underwater autonomous manipulation" was selected for an AFCV Best Robot Vision Paper Award at KRoC 2016.</p></div>
</div>

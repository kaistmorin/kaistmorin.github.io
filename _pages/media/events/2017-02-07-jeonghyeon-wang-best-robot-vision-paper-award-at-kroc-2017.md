---
layout: default
title: "Jeonghyeon Wang — Best Robot Vision Paper Award at KRoC 2017"
permalink: /media/events/2017-02-07-jeonghyeon-wang-best-robot-vision-paper-award-at-kroc-2017/
nav: false
---
...
<div class="media-detail">
  ...
  <h1>Jeonghyeon Wang — Best Robot Vision Paper Award at KRoC 2017</h1>
  <p class="detail-date">2017-02-07</p>
  <div class="detail-hero"><img src="{{ '/assets/img/media/events/event-29.jpg' | relative_url }}" alt="Jeonghyeon Wang — Best Robot Vision Paper Award at KRoC 2017"></div>
  <div class="detail-body"><p>The paper "Semantic Segmentation of Urban Scenes using a Relative Location Model" received an AFCV Best Robot Vision Paper Award.</p></div>
</div>

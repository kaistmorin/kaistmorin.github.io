---
layout: default
title: "Seonghun Hong — Grand Prize at KAOSTS Paper Contest"
permalink: /media/events/2017-04-20-seonghun-hong-grand-prize-at-kaosts-paper-contest/
nav: false
---
...
<div class="media-detail">
  ...
  <h1>Seonghun Hong — Grand Prize at KAOSTS Paper Contest</h1>
  <p class="detail-date">2017-04-20</p>
  <div class="detail-hero"><img src="{{ '/assets/img/media/events/event-27.jpg' | relative_url }}" alt="Seonghun Hong — Grand Prize at KAOSTS Paper Contest"></div>
  <div class="detail-body"><p>The paper "A Robust loop-closure method for visual SLAM in unstructured seafloor environment" received the grand prize at the KAOSTS Paper Contest.</p></div>
</div>

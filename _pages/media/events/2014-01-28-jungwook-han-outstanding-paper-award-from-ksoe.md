---
layout: default
title: "Jungwook Han — Outstanding Paper Award from KSOE"
permalink: /media/events/2014-01-28-jungwook-han-outstanding-paper-award-from-ksoe/
nav: false
---
...
<div class="media-detail">
  ...
  <h1>Jungwook Han — Outstanding Paper Award from KSOE</h1>
  <p class="detail-date">2014-01-28</p>
  <div class="detail-hero"><img src="{{ '/assets/img/media/events/event-42.jpg' | relative_url }}" alt="Jungwook Han — Outstanding Paper Award from KSOE"></div>
  <div class="detail-body"><p>The paper "3D reconstruction of bridge structures by sensor fusion using a USV" received an Outstanding Student Paper Award from KSOE.</p></div>
</div>

---
layout: default
title: "Sukmin Yoon — Outstanding Paper Award at ICROS"
permalink: /media/events/2017-05-04-sukmin-yoon-outstanding-paper-award-at-icros/
nav: false
---
...
<div class="media-detail">
  ...
  <h1>Sukmin Yoon — Outstanding Paper Award at ICROS</h1>
  <p class="detail-date">2017-05-04</p>
  <div class="detail-hero"><img src="{{ '/assets/img/media/events/event-25.jpg' | relative_url }}" alt="Sukmin Yoon — Outstanding Paper Award at ICROS"></div>
  <div class="detail-body"><p>The paper "Efficient multi-agent task allocation algorithm considering inactive agents constraints" received an Outstanding Paper Award.</p></div>
</div>

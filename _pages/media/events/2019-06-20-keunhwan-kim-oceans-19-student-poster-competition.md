---
layout: default
title: "Keunhwan Kim — OCEANS'19 Student Poster Competition"
permalink: /media/events/2019-06-20-keunhwan-kim-oceans-19-student-poster-competition/
nav: false
---
...
<div class="media-detail">
  ...
  <h1>Keunhwan Kim — OCEANS'19 Student Poster Competition</h1>
  <p class="detail-date">2019-06-20</p>
  <div class="detail-hero"><img src="{{ '/assets/img/media/events/event-19.jpg' | relative_url }}" alt="Keunhwan Kim — OCEANS&#x27;19 Student Poster Competition"></div>
  <div class="detail-body"><p>The paper "Semantic Segmentation of Marine Radar Images using Convolutional Neural Networks" was selected for the MTS/IEEE OCEANS’19 Student Poster Competition in Marseille, France.</p></div>
</div>

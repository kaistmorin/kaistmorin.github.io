---
layout: default
title: "Kyungseo Kim — Outstanding Paper Award at ICROS 2022"
permalink: /media/events/2022-06-23-kyungseo-kim-outstanding-paper-award-at-icros-2022/
nav: false
---
...
<div class="media-detail">
  ...
  <h1>Kyungseo Kim — Outstanding Paper Award at ICROS 2022</h1>
  <p class="detail-date">2022-06-23</p>
  <div class="detail-hero"><img src="{{ '/assets/img/media/events/event-11.jpg' | relative_url }}" alt="Kyungseo Kim — Outstanding Paper Award at ICROS 2022"></div>
  <div class="detail-body"><p>The paper "Action Sequence Planning for Efficient Mine Detection Using Multiple Autonomous Underwater Vehicles" received an Outstanding Paper Award at ICROS 2022.</p></div>
</div>

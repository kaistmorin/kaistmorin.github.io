---
layout: default
title: "Junwoo Jang — Outstanding Student Paper Presentation Award"
permalink: /media/events/2021-01-21-junwoo-jang-outstanding-student-paper-presentation-award/
nav: false
---
...
<div class="media-detail">
  ...
  <h1>Junwoo Jang — Outstanding Student Paper Presentation Award</h1>
  <p class="detail-date">2021-01-21</p>
  <div class="detail-hero"><img src="{{ '/assets/img/media/events/event-14.jpg' | relative_url }}" alt="Junwoo Jang — Outstanding Student Paper Presentation Award"></div>
  <div class="detail-body"><p>The paper "Self-supervised Depth Estimation using a Monocular Camera in Maritime Environments" received an Outstanding Student Paper Presentation Award from KSOE 2020.</p></div>
</div>

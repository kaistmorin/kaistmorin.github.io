---
layout: default
title: "Dongha Chung — Grand Prize at KAOSTS Paper Contest"
permalink: /media/events/2024-05-23-dongha-chung-grand-prize-at-kaosts-paper-contest/
nav: false
---
...
<div class="media-detail">
  ...
  <h1>Dongha Chung — Grand Prize at KAOSTS Paper Contest</h1>
  <p class="detail-date">2024-05-23</p>
  <div class="detail-hero"><img src="{{ '/assets/img/media/events/event-06.jpg' | relative_url }}" alt="Dongha Chung — Grand Prize at KAOSTS Paper Contest"></div>
  <div class="detail-body"><p>The IJRR paper "Pohang Canal Dataset: A Multimodal Maritime Dataset for Autonomous Navigation in Restricted Waters" received the grand prize in the KAOSTS Paper Contest.</p></div>
</div>

---
layout: default
title: "Jisung Park — Outstanding Student Paper & Presentation Award"
permalink: /media/events/2014-05-23-jisung-park-outstanding-student-paper-presentation-award/
nav: false
---
...
<div class="media-detail">
  ...
  <h1>Jisung Park — Outstanding Student Paper & Presentation Award</h1>
  <p class="detail-date">2014-05-23</p>
  <div class="detail-hero"><img src="{{ '/assets/img/media/events/event-41.jpg' | relative_url }}" alt="Jisung Park — Outstanding Student Paper &amp; Presentation Award"></div>
  <div class="detail-body"><p>The work "A preliminary study on autonomous object detection and retrieval in underwater environment" received an award at the 2014 spring conference of KSOE.</p></div>
</div>

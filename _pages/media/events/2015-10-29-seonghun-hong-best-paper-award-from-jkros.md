---
layout: default
title: "Seonghun Hong — Best Paper Award from JKROS"
permalink: /media/events/2015-10-29-seonghun-hong-best-paper-award-from-jkros/
nav: false
---
...
<div class="media-detail">
  ...
  <h1>Seonghun Hong — Best Paper Award from JKROS</h1>
  <p class="detail-date">2015-10-29</p>
  <div class="detail-hero"><img src="{{ '/assets/img/media/events/event-38.jpg' | relative_url }}" alt="Seonghun Hong — Best Paper Award from JKROS"></div>
  <div class="detail-body"><p>The paper "Visual SLAM using Local Bundle Optimization in Unstructured Seafloor Environment" was selected as the best paper among papers published in JKROS in 2014.</p></div>
</div>

...
layout: default
title: "MORIN KMRTS"
permalink: /media/gallery/2026-06-morin-kmrts/
nav: false
---
...
<div class="media-detail">
  ...
  <h1>MORIN KMRTS</h1>
  <p class="detail-date">2026-06</p>
  <div class="detail-hero"><img src="{{ '/assets/img/media/gallery/gallery-01.jpg' | relative_url }}" alt="MORIN KMRTS"></div>
  <div class="detail-body"><p>Together with Professor Jinwhan Kim, the president of the society, we attended the Korea Marine Robot Technology Society (KMRTS) conference.</p></div>
</div>

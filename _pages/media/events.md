...
<div class="media-archive">
  ...
  <h1>Events</h1>
  <p class="media-intro">Selected conference activities, awards, and special events.</p>
  <div class="archive-grid">

    <article class="archive-card">
      <a href="#">
        <div class="media-thumb">
          <img src="{{ '/assets/img/media/events/conference.jpg' | relative_url }}" alt="Conference Activities">
        </div>
        <div class="archive-meta">
          <p class="media-label">Conference</p>
          <h3 class="media-title">Conference Activities</h3>
        </div>
      </a>
    </article>
    <article class="archive-card">
      <a href="#">
        <div class="media-thumb">
          <img src="{{ '/assets/img/media/events/award.jpg' | relative_url }}" alt="Awards & Recognition">
        </div>
        <div class="archive-meta">
    ...
    <article class="archive-card">
      <a href="#">
        <div class="media-thumb">
          <img src="{{ '/assets/img/media/events/special-event.jpg' | relative_url }}" alt="Special Events">
        </div>
        <div class="archive-meta">
          <p class="media-label">Event</p>
          <h3 class="media-title">Special Events</h3>
        </div>
      </a>
    </article>
  </div>
